...
with open('iteration30LAPTOP.csv', 'r') as file:
...
with open('iteration30vm.csv', 'r') as file:
...
with open('iteration30docker.csv', 'r') as file:
...
plt.xlabel('Number of iteration (30)');
plt.ylabel('Time of execution');
plt.legend(["Laptop","VM","Docker"]);
plt.title('Time of execution for multiplacation of matrix for 30 iterations');
plt.show();