...
with open('iteration50vm.csv', 'r') as file:
...
with open('iteration50docker.csv', 'r') as file:
...
plt.xlabel('Number of iteration (50)');
plt.ylabel('Time of execution');
plt.legend(["Laptop","VM","Docker"]);
plt.title('Time of execution for multiplacation of matrix for 50 iterations');
plt.show();