...
with open('iteration80LAPTOP.csv', 'r') as file:
...
with open('iteration80vm.csv', 'r') as file:
...
with open('iteration80docker.csv', 'r') as file:
...
plt.xlabel('Number of iteration (80)');
plt.ylabel('Time of execution');
plt.legend(["Laptop","VM","Docker"]);
plt.title('Time of execution for multiplacation of matrix for 80 iterations');
plt.show();
