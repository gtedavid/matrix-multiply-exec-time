...
with open('iteration100LAPTOP.csv', 'r') as file:
...
with open('iteration100vm.csv', 'r') as file:
...
with open('iteration100docker.csv', 'r') as file:
...
plt.title('Time of execution for multiplacation of matrix for 100 iterations');
plt.show();